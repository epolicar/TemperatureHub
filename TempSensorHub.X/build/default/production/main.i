...
# 229 "./mcc_generated_files/system/../system/pins.h"
...
# 300 "./mcc_generated_files/system/../uart/eusart1.h"
uint8_t EUSART1_Read(void);
# 310 "./mcc_generated_files/system/../uart/eusart1.h"
...
# 335 "./mcc_generated_files/system/../uart/eusart1.h"
...
# 360 "./mcc_generated_files/system/../uart/eusart1.h"
...
# 45 "./mcc_generated_files/system/../uart/eusart2.h"
...
# 45 "./mcc_generated_files/system/../uart/eusart2.h" 2

# 1 "./mcc_generated_files/system/../uart/../system/system.h" 1
# 46 "./mcc_generated_files/system/../uart/eusart2.h" 2
...
# 115 "./mcc_generated_files/system/../uart/eusart2.h"
extern const uart_drv_interface_t UART2;
# 124 "./mcc_generated_files/system/../uart/eusart2.h"
...
# 157 "./mcc_generated_files/system/../uart/eusart2.h"
...
# 174 "./mcc_generated_files/system/../uart/eusart2.h"
...
# 191 "./mcc_generated_files/system/../uart/eusart2.h"
...
# 240 "./mcc_generated_files/system/../uart/eusart2.h"
_Bool EUSART2_IsRxReady(void);
# 249 "./mcc_generated_files/system/../uart/eusart2.h"
_Bool EUSART2_IsTxReady(void);
# 258 "./mcc_generated_files/system/../uart/eusart2.h"
...
# 276 "./mcc_generated_files/system/../uart/eusart2.h"
uint8_t EUSART2_Read(void);
# 286 "./mcc_generated_files/system/../uart/eusart2.h"
...
void test1(int loop){
    for( int i=0; i<loop; i++) {
        LATD2 = 1;
        _delay((unsigned long)((500)*(12000000U/4000.0)));
...
CircularBuffer dataBuffer = { .head = 0, .tail = 0, .full = 0 };
...
void buffer_write(CircularBuffer *buf, uint16_t data) {
    ...
    if (buf->full) {
        buf->tail = (buf->tail + 1) % 2;
    }

    buf->head = (buf->head + 1) % 2;
    buf->full = (buf->head == buf->tail);
}


_Bool buffer_read(CircularBuffer *buf, uint16_t *data) {
...
# 236 "main.c"
    ...
    if (PORTAbits.RA0) {
        ...
        do { ANSELDbits.ANSD0 = 0; } while(0);
        do { ANSELDbits.ANSD1 = 0; } while(0);
        ...
        while (1) {
            ...
            UART_SendChar((temperature >> 8) & 0xFF);
            UART_SendChar(temperature & 0xFF);

            temperature = temperature >> 7;
            printf("Temperature: %u\n\r", temperature);
            _delay((unsigned long)((100)*(12000000U/4000.0)));
