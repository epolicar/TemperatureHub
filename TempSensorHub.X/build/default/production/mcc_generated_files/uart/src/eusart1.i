...
# 45 "mcc_generated_files/uart/src/../../system/../uart/eusart2.h"
...
# 45 "mcc_generated_files/uart/src/../../system/../uart/eusart2.h" 2
...
# 47 "mcc_generated_files/uart/src/../../system/../uart/eusart2.h" 2
...
static volatile uint8_t eusart1RxBuffer[(8U)];





static volatile eusart1_status_t eusart1RxStatusBuffer[(8U)];
...
size_t EUSART1_ErrorGet(void)
{
    eusart1RxLastError.status = eusart1RxStatusBuffer[(eusart1RxTail) & ((8U) - 1U)].status;
...
uint8_t EUSART1_Read(void)
{
    ...
    tempRxTail = (eusart1RxTail + 1U) & ((8U) - 1U);
...
void EUSART1_ReceiveISR(void)
{
 ...
 uint8_t tempRxHead;
    ...
    tempRxHead = (eusart1RxHead + 1U) & ((8U) - 1U);
